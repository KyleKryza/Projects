    ...
    public class EditModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    String singleClientQuery = "SELECT * FROM clients WHERE id=@id";
                    using (SqlCommand command = new SqlCommand(singleClientQuery, connection))
                    {
        ...
        public void OnPost()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    String createClientQuery = "UPDATE clients " +
                                               "SET name=@name, email=@email, phone=@phone, address=@address " +
                                               "WHERE id=@id;";
                    using (SqlCommand command = new SqlCommand(createClientQuery, connection))
                    {
